...
export const programs = [
  ...
  },
  {
    ...
    description: 'Othelo written typescript react, typescript node. I made this for a class final project.',
    meta: 'Typescript-React Typescript-Node socket.io mysql 2026',
    page: '/code/othello',
    ref: 'oth2026',
    mediaLink: 'codepage/othicon.png',
    referenceLinks: [
      {
        title: 'othello github repo',
        url: 'https://github.com/sebgorgone/othello'
      }
    ]
  }
...
export const othello: Widget[] = [
  ...
  },
  {
    format: 4,
    src: 'oth/solo.png',
    text: 'Fast-paced online multiplayer matches using sockets — join or create a room and play against others.'
  },
  {
    format: 0,
    src: '',
    text: 'Othello Online is a full-stack multiplayer web application built with TypeScript (React + Node). The backend manages game rules and matchmaking while the frontend provides a responsive board and real-time updates. Matches are played over sockets and game state is persisted to the database.'
  },
  {
    format: 3,
    src: 'oth/duo.png',
    text: 'Match UI and player indicators for two-player real-time games.'
  }
];
